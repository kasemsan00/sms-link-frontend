...
export default function Record({ uuid }) {
    ...
    return (
        <>
            <StatusBarGeo uuid={uuid} show={!isStartRecord ? true : false} />
            <StatusBarVideo start={isStartRecord} type="videorecord" show={!isStartRecord ? false : true} />
